<?php
header( "refresh:3600;url=index_tv.php" );
?>
 <?php
...
body  {
 ...
 background-image: url(c.jpg), url(b.jpg);
  ...
  background-repeat: no-repeat, no-repeat;
   background-size: 1350px 40px, 1600px ;
...
<td colspan='6' width='700px' align="center">

<font size='4.5px' color='white'>
<span class="blinking">.:: <?php  echo "$aa"; ?> ::.</span>
</font>
</td>
...
<div id="blink1" onchange="myFunction()"  class="row loket1">
</div>
</td>

<td width='100px' colspan='2' align='center' class='fontsize'>
</td>

<td rowspan='3' colspan='2'  >
&nbsp;&nbsp;
<body onload="onload();">
    <video id="idle_video" width="90%" height='76%' onended="onVideoEnded();" muted="muted"></video>
    <script>
        var video_list      = [		
		<?php
...
<div class="row loket4">
</div>
<div class="row loket5">
</div>
</td>
<td width='100px' colspan='2' align='center' class='fontsize'>
</td>
...
<td width='100px' colspan='3'><font size='6px' color='white'>
