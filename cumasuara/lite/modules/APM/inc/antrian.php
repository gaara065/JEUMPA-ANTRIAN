...
<body>
  ...
  <div class="px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center mb-4">
    <div class="text-white display-3">RSB JEUMPA PONTIANAK</div>
  </div>
      ...
      <div class="col-9">
        <div class="card bg-dark text-white">
          <div class="embed-responsive embed-responsive-16by9">
            <iframe class="embed-responsive-item" src="//www.youtube.com/embed/y5OGp9V4hWs?version=3&autoplay=1&loop=1&playlist=y5OGp9V4hWs"></iframe>
          </div>
        </div>
      </div>
      <div class="col-3 ">
        <a href="antrian.php?action=panggil_loket" style="text-decoration:none; color:#000;">
          <div class="card border-success mb-4">
            <div class="card-body text-success">
              <div style="font-size:75px;font-weight:lighter;padding-top:10px;padding-bottom:10px;margin-top:-45px;margin-bottom:-45px;"><span class="antrian_loket"><span></div>
            </div>
        ...
        <a href="antrian.php?action=panggil_loket" style="text-decoration:none; color:#000;">
          <div class="card border-success mb-4">
            <div class="card-body text-success">
              <div style="font-size:75px;font-weight:lighter;padding-top:10px;padding-bottom:10px;margin-top:-45px;margin-bottom:-45px;"><span class="antrian_loket2"><span></div>
            </div>
            <div class="card-footer bg-transparent border-success" style="font-size:39px;padding-top:0;padding-bottom:0;">Loket <span class="get_loket2"><span></div>
          </div>
        </a>
        <a href="antrian.php?action=panggil_prioritas" style="text-decoration:none; color:#000;">
          <div class="card border-success mb-4">
            <div class="card-body text-success">
              <div style="font-size:75px;font-weight:lighter;padding-top:10px;padding-bottom:10px;margin-top:-45px;margin-bottom:-45px;"><span class="antrian_prioritas"><span></div>
            </div>
            <div class="card-footer bg-transparent border-success" style="font-size:39px;padding-top:0;padding-bottom:0;">Loket Apotik</div>
          </div>
        </a>
...
setInterval(function(){ getAntrianLoket2(); }, 2000);

function getAntrianLoket2() {
  $.ajax({
    url: 'includes/antriloket2.php',
    type: 'post',
    success: function(data) {
      $('.antrian_loket2').html(data);
    }
  });
};
...
setInterval(function(){ getLoket2(); }, 2000);

function getLoket2() {
  $.ajax({
    url: 'includes/loket2.php',
    type: 'post',
    success: function(data) {
      $('.get_loket2').html(data);
    }
  });
};
