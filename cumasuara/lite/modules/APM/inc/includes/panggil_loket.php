...
<audio id="a" src="suara/a.wav"  ></audio>
			...
			<?php foreach($loket as $value){ ?>
				<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 mb-5">
			      ...
			      <div class="card-header" style="font-size:32px;">Loket <?php echo $value; ?></div>
				    <div class="card-body">
							<h5 class="card-title" style="font-size:72px;">A<?php echo $antrian; ?></h5>
				    </div>
				    <div class="card-footer p-0">
							<div class="btn-group btn-group-justified">
							
							  <a href="#" class="btn btn-primary" style="font-size:32px;"><i class="fas fa-bullhorn" onclick="mulai<?php echo $value; ?>();"></i>asdasdas</a>
							  <a href="antrian.php?action=panggil_loket&loket=<?php echo $value; ?>" class="btn btn-primary" style="font-size:32px;"><i class="fas fa-forward"></i></a>
							</div>
				    </div>
				  </div>
					</div>
...
function mulai<?php echo $value; ?>(){
	...
	setTimeout(function() { $("#a")[0].play() }, totalwaktu);
