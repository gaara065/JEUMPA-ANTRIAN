...
<html lang="en">
    ...
    <div class="container">
        <button class="btn btn-small btn-primary try_queue" type="button" style="float:right;padding:20px;">
            Panggil &nbsp;<span class="glyphicon glyphicon-volume-up"></span>    
        </button>
        ...
        <p>
	        <a class="btn btn-lg btn-success next_queue" href="#" role="button">
	        	No Selanjutnya &nbsp;<span class="glyphicon glyphicon-chevron-right"></span>
    	...
    	<form>
        	<label for="exampleInputEmail1" style="text-align: left;"><span class="glyphicon glyphicon-credit-card">&nbsp;</span>LOKET 1</label> 
        	<select style="display:none;" class="form-control loket" name="loket" required>
