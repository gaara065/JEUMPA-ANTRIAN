 ...
 include "../apps/mysql_connect.php";
		...
		$results = $mysqli->query("SELECT * FROM data_antrian where gru='1' order by id desc");	
		...
		$cc = $results['gru'];
	  	...
	  	$resultsa = $mysqli->query("SELECT count(*) as no_loket FROM data_antrian where status='3' and gru='1'  and (counter='0' or counter='1') ");	
